          ...
          <section className="pt-20 text-center fade-in-section">
            <div className="space-y-6">
              ...
              <p className="text-xl text-muted-foreground max-w-3xl mx-auto leading-relaxed">
                Educational communication platform designed for clarity and strategic knowledge dissemination across academic institutions.
              </p>
            </div>
          </section>
              ...
              <div className="space-y-8 mb-12">
                <div className="aspect-[16/10] bg-card rounded-lg border border-border/30 flex items-center justify-center">
                  <div className="text-center space-y-3">
                    ...
                    <p className="text-lg text-muted-foreground">Desktop Interface</p>
                    <p className="text-sm font-mono text-accent">MAIN DASHBOARD</p>
                  </div>
                </div>
                ...
                <div className="grid md:grid-cols-2 gap-6">
                  <div className="aspect-[16/10] bg-card rounded-lg border border-border/30 flex items-center justify-center">
                    <div className="text-center space-y-2">
                      ...
                      <p className="text-xs font-mono text-accent">MESSAGING SYSTEM</p>
                    </div>
                  </div>
                  ...
                  <div className="aspect-[16/10] bg-card rounded-lg border border-border/30 flex items-center justify-center">
                    <div className="text-center space-y-2">
                      ...
                      <p className="text-xs font-mono text-accent">USER DASHBOARD</p>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div className="tactical-card text-center space-y-8">
              <div>
                ...
                <p className="text-muted-foreground max-w-3xl mx-auto leading-relaxed">
                  ...
                  and enterprise-grade security measures for educational environments.
                </p>
              </div>
              ...
              <div className="grid md:grid-cols-3 gap-6">
                <div className="space-y-3">
                  ...
                  <h4 className="font-mono text-sm uppercase tracking-wide">Real-time Communication</h4>
                  <p className="text-xs text-muted-foreground">WebSocket-based messaging</p>
                </div>
